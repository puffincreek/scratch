...
public abstract class Pool<T> implements Closeable {
  ...
  public T getResource() {
    try {
      ...
      System.err.println("NSE getting a resource from pool: ".concat(nse.getMessage()));
      if(nse.getCause() != null) {
        System.err.println("cause: ".concat(nse.getCause().toString()));
      }
      ...
      System.err.println("Exception getting a resource from pool: ".concat(e.getMessage()));
      if(e.getCause() != null) {
        System.err.println("cause: ".concat(e.getCause().toString()));
      }
